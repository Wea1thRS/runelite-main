...
public class VorkathPlugin2 extends Plugin
{
	@Inject
	private OverlayManager overlayManager;

	@Inject
	private VorkathConfig2 config;

	@Inject
	private VorkathOverlay2 VorkathOverlay;
	...
	@Provides
	VorkathConfig2 provideConfig(ConfigManager configManager) {
		return configManager.getConfig(VorkathConfig2.class);
	}
